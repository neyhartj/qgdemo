#' Simulate a stochastic population
#' 
#' @param p The initial frequency of the \code{A} allele.
#' @param N The effective population size
#' @param t The number of generations
#' @param f The standarized fitness. Must be a numeric vector of length 3 and
#' indicates the standardized fitness for the p homozygote, the heterozygote, and
#' the q homozygote, respectively.
#' @param reps The number of replicate scenarios to run
#' 
#' @export
#' 
...
#' 
#' @param par1 A 2 x m matrix of parent 1 haplotypes, where m is the number of genes.
#' @param par2 A 2 x m matrix of parent 2 haplotypes, where m is the number of genes.
#' 
#' @export
#' 
...
#' Simulate a breeding population
#' 
#' @param p Starting allele frequency
#' @param N Breeding population size
#' @param t Number of breeding generations
#' @param h Trait heritability
#' @param L Number of QTL
#' @param i Intensity of selection
#' @param a Vector of additive allele effects
#' @param mu The base population mean
#' 
#' @export
#' 
